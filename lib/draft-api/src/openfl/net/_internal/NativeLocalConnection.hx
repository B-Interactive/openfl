...
extern class NativeLocalConnection 
{
	...
	@:native('native_read') private static function __read(pipe:HANDLE, buffer:Pointer<UInt8>, size:Int):Bool;
	@:native('native_write') private static function __write(pipe:HANDLE, data:String):Bool;
